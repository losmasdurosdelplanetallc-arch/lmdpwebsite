...
function briefText() {
  if (!briefForm) {
    return currentLanguage === "es"
      ? "Quiero%20crear%20algo%20con%20LMDP."
      : "I%20want%20to%20build%20something%20with%20LMDP.";
  }
  ...
  if (currentLanguage === "es") {
    ...
    return `Brief de proyecto LMDP%0A%0ANombre: ${encodeURIComponent(name)}%0AServicio: ${encodeURIComponent(displayService)}%0APresupuesto: ${encodeURIComponent(budget)}%0AProyecto: ${encodeURIComponent(message)}`;
  }
...
emailButton?.addEventListener("click", () => {
  const subject = currentLanguage === "es" ? "Brief%20de%20Proyecto%20LMDP" : "LMDP%20Project%20Brief";
